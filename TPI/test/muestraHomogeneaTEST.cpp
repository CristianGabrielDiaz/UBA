...
TEST(muestraHomogeneaTEST, dosSolucionesDe3) {
    vector <hogar> res1 = {{1,    2018, 1, 1, 2, 1, 1, 1, 1, 2,1,1},//24
                           {210,  2018, 1, 1, 2, 1, 1, 1, 1, 2,1,1},//27
                           {340,  2018, 1, 1, 1, 1, 1, 1, 1, 2,1,1}};//30

    vector <hogar> res2 = {{1,    2018, 1, 1, 2, 1, 1, 1, 1, 2,1,1},//24
                           {210,  2018, 1, 1, 2, 1, 1, 1, 1, 2,1,1},//27
                           {4377, 2018, 1, 1, 2, 1, 1, 1, 1, 2,1,1}};//30
    ...
    eph_h th = {
            ...
            {4377, 2018, 1, 1, 2, 1, 1, 1, 1, 2,1,1},//30
            {200,  2018, 1, 1, 2, 1, 1, 1, 1, 2,1,1},//0
            {334,  2018, 1, 1, 2, 1, 1, 1, 1, 2,1,1},//3
            {543,  2018, 1, 1, 2, 1, 1, 1, 1, 2,1,1},//1
            {2354, 2018, 1, 1, 2, 1, 1, 1, 1, 2,1,1},//20
            {1,    2018, 1, 1, 2, 1, 1, 1, 1, 2,1,1},//24
            {800,  2018, 1, 1, 2, 1, 1, 1, 1, 2,1,1},//0
    };
